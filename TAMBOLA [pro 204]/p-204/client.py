...
def askPlayerName():
    ...
    canvas1 = Canvas(nameWindow,width = 500,heigth=500)
    ...
    button = Button(nameWindow, text="Save", font =("Chalkboard SE",30),width=11,height=2,bg="#80deea",bd=3)
